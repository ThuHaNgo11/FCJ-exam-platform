...
export default function ExamUpdateForm(props) {
  const {
    id: idProp,
    exam: examModelProp,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = examRecord
      ? { ...initialValues, ...examRecord }
      : initialValues;
    setDate(cleanValues.date);
    setOrg(cleanValues.org);
    setData(cleanValues.data);
    setErrors({});
  };
  const [examRecord, setExamRecord] = React.useState(examModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Exam, idProp)
        : examModelProp;
      setExamRecord(record);
    };
    queryData();
  }, [idProp, examModelProp]);
  React.useEffect(resetStateValues, [examRecord]);
  const validations = {
    date: [],
    org: [],
    data: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Exam.copyOf(examRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ExamUpdateForm")}
      {...rest}
    >
      <TextField
        label="Date"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || examModelProp)}
