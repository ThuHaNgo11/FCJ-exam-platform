...
const QuestionList = () => {
    ...
    const colWidths = ["30px", "360px", "250px", "250px"]
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell as="th" minWidth={colWidths[2]} flex={"1 1 auto"}>Content</TableCell>
                                ...
                                questions.map(
                                    (question) => (
                                        <TableRow key={question.id}>
                                            ...
                                            <TableCell minWidth={colWidths[2]} flex={"1 1 auto"}>
